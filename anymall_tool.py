...
def show_anymall_page():
    st.markdown("""
        <style>
            ...
            div[data-testid="column"]:nth-of-type(6) > div { display: flex !important; flex-direction: row !important; justify-content: center !important; align-items: center !important; width: 100% !important; height: 100% !important; }

            /* ✨ PDF 下載按鈕的專屬樣式，避免被上面全局覆蓋 */
